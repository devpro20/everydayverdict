  ...
  return (
    <section className="relative w-full py-20 flex flex-col items-center justify-center text-center overflow-hidden mb-16 bg-mesh shadow-2xl ring-1 ring-white/10">
      ...
      <div className="relative z-10 px-6 max-w-4xl glass py-10 md:py-12 rounded-3xl">
        <div className="inline-flex items-center px-3 py-1 rounded-full border border-brand-500/30 bg-brand-500/10 text-brand-400 text-sm font-medium mb-6 backdrop-blur-md">
          <span className="flex w-2 h-2 rounded-full bg-brand-400 mr-2 animate-pulse"></span>
          Next.js + Prisma + Tailwind v4
        </div>
